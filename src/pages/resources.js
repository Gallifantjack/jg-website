  ...
  return (
    <section id="my-work">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 md:px-8">
        ...
        />
        <Caption className="text-pink-500 dark:text-pink-400">About Me</Caption>
        <BigText>
        ...
        <Paragraph>
          ...
          working at the Lab for Computational Physiology.
          ...
          I have previously worked as a full-time physician working in Imperial College London NHS Trust. 
        </Paragraph>
      ...
      <div className="mt-10 max-w-7xl mx-auto px-4 sm:px-6 md:px-8">
        ...
        <Button className= 'my-10' href="https://www.youtube.com/tailwindlabs">See the full list of publications</Button>
      </div>
    </section>
  )
}
