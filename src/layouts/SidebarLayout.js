  ...
  return (
    <>
      <TopLevelLink
        ...
        isActive={pathname === '/docs/background'}
        className="mb-4"
      ...
      <TopLevelLink
        ...
        isActive={pathname === '/docs/experience'}
        className="mb-4"
      ...
      >
        <span className={pathname === '/docs/experience' ? 'dark:text-purple-400' : ''}>Experience</span>
      </TopLevelLink>
      <TopLevelLink
        mobile={mobile}
        href="/docs/research-interests"
        isActive={pathname === '/docs/research-interests'}
        className="mb-4"
        shadow="group-hover:shadow-purple-200 dark:group-hover:bg-purple-400"
        activeBackground="dark:bg-purple-400"
        icon={
          <>
            <path
              ...
              className={clsx(
                'fill-purple-400 group-hover:fill-purple-500 dark:group-hover:fill-purple-300',
                pathname === '/docs/research-interests'
                  ? 'dark:fill-purple-300 dark:group-hover:fill-purple-300'
                  : mobile
                  ? 'dark:fill-slate-500'
                  : 'dark:fill-slate-600'
      ...
      >
        <span className={pathname === '/docs/research-interests' ? 'dark:text-purple-400' : ''}>Research Interests</span>
      </TopLevelLink>
    </>
  )
}
